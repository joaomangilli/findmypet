...
ActiveRecord::Schema[8.1].define(version: 2026_04_14_191513) do
  create_schema "tiger"
  ...
  create_table "public.announcements", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "description"
    t.string "last_seen_address"
    t.datetime "last_seen_at"
    t.geography "last_seen_location", limit: {:srid=>4326, :type=>"st_point", :geographic=>true}
    t.integer "notification_radius_km", default: 5, null: false
    t.bigint "pet_id", null: false
    t.integer "status", default: 0, null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["last_seen_location"], name: "index_announcements_on_last_seen_location", using: :gist
    t.index ["pet_id"], name: "index_announcements_on_pet_id"
    t.index ["status"], name: "index_announcements_on_status"
    t.index ["user_id"], name: "index_announcements_on_user_id"
  end

  create_table "public.otp_codes", force: :cascade do |t|
  ...
  create_table "public.pets", force: :cascade do |t|
    t.string "breed"
    t.string "color"
    t.datetime "created_at", null: false
    t.text "description"
  ...
  create_table "public.sightings", force: :cascade do |t|
    t.string "address"
    ...
    t.boolean "saw_it", default: true, null: false
    t.datetime "seen_at"
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["announcement_id"], name: "index_sightings_on_announcement_id"
    t.index ["location"], name: "index_sightings_on_location", using: :gist
    t.index ["user_id"], name: "index_sightings_on_user_id"
  end

  create_table "public.subscribers", force: :cascade do |t|
    t.string "address"
    t.datetime "created_at", null: false
  ...
  create_table "public.whatsapp_notifications", force: :cascade do |t|
    t.bigint "announcement_id", null: false
    t.datetime "created_at", null: false
    t.datetime "sent_at"
    t.integer "status", default: 0, null: false
    ...
    t.datetime "updated_at", null: false
    t.index ["announcement_id"], name: "index_whatsapp_notifications_on_announcement_id"
    t.index ["subscriber_id"], name: "index_whatsapp_notifications_on_subscriber_id"
  end

  add_foreign_key "public.announcements", "public.pets"
  add_foreign_key "public.announcements", "public.users"
  add_foreign_key "public.pets", "public.users"
  add_foreign_key "public.sightings", "public.announcements"
  add_foreign_key "public.sightings", "public.users"
  add_foreign_key "public.whatsapp_notifications", "public.announcements"
  add_foreign_key "public.whatsapp_notifications", "public.subscribers"
